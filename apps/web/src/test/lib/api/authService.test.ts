...
describe('authService', () => {
  it('login envía correo y password, retorna accessToken', async () => {
    mockedClient.post.mockResolvedValue({ data: { accessToken: 'jwt-token-123' } })
  ...
  it('getMe retorna el usuario autenticado', async () => {
    const mockUsuario = {
